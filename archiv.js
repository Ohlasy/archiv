...
var _Ohlasy$archiv$Article$convertDateToISO8601 = function (_p0) {
	return A3(
		_elm_community$string_extra$String_Extra$replace,
		' ',
		'T',
		A3(_elm_community$string_extra$String_Extra$replace, ' +0000', '', _p0));
};
var _Ohlasy$archiv$Article$pubDateDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (s) {
		var _p1 = _elm_lang$core$Date$fromString(
			_Ohlasy$archiv$Article$convertDateToISO8601(s));
		if (_p1.ctor === 'Err') {
...
var _Ohlasy$archiv$Article$articleDecoder = A3(
	...
	'pubDate',
	_Ohlasy$archiv$Article$pubDateDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'serial',
...
var _Ohlasy$archiv$Views$renderArticle = function (article) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(absoluteURL),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _Ohlasy$archiv$Views$renderFilter = F3(
	function (articles, settings, f) {
		...
		var action = function (tag) {
			return _elm_lang$core$Native_Utils.eq(tag, noFilterPlaceholder) ? A2(_Ohlasy$archiv$State$UpdateFilterValue, f, _elm_lang$core$Maybe$Nothing) : A2(
				_Ohlasy$archiv$State$UpdateFilterValue,
				f,
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '::', _0: noFilterOption, _1: valueOptions}),
					_1: {ctor: '[]'}
				}
			});
	});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Ohlasy$archiv$Main$main !== 'undefined') {
    _Ohlasy$archiv$Main$main(Elm['Main'], 'Main', undefined);
}
